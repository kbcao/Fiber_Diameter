...
dataset = read_csv('Data/12.13.csv', index_col=0)
dataset.index.name = 'date'
dataset.columns = ['current', 'squeeze_speed', 'drag_speed', 'diameter']
...
reframed.drop(reframed.columns[range(4 * (prediction_basesize + 1) - 4, 4 * (prediction_basesize + 1) - 1)], axis=1,
              inplace=True)
